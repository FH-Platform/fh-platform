...
namespace FHPlatform\Bundle\PersistenceBundle\Builder;

use Doctrine\ORM\Events;
use FHPlatform\Bundle\PersistenceBundle\EventListener\PersistenceEventListener;
...
class PersistenceBuilder
{
    ...
    public function buildPersistence(): void
    {
        ...
        $container->register(PersistenceManager::class)->setAutowired(true)->setAutoconfigured(true)->setPublic(true);
