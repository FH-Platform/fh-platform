...
class Basic2Test extends TestCaseEntitiesRelated
{
    public function testSomething(): void
    {
        ...
        $this->assertEquals([], $this->entitiesRelatedBuilder->build($setting, $doctrineUpdatingMap, ChangedEntityEvent::TYPE_UPDATE, ['testFloat']));
        $this->assertEquals([
            'user' => [
                1 => $user,
            ],
        ...
        ], $this->entitiesRelatedBuilder->build($setting, $doctrineUpdatingMap, ChangedEntityEvent::TYPE_UPDATE, ['testBoolean', 'testString']));
    }
}
